    ...
    $options = [
      ...
      'seller' => [
        ...
        'start_selling' => [
          'status' => true,
          'title' => "Start Selling",
          'description' => $this->baseName . " marketplace is Lebanon's leading platform for selling online. Be it a manufacturer, vendor or supplier, simply sell your products online on " . $this->baseName . " and become a top ecommerce player with minimum investment. Through a team of experts offering exclusive seller workshops, training, seller support and convenient seller portal, " . $this->baseName . " focuses on educating and empowering sellers across Lebanon. Selling on " . " is easy and absolutely free. All you need is to register, list your catalogue and start selling your products."
        ],
